...
<body>
    <header class="main-header sticky-top">
        <div class="container">
            ...
            <div class="page-name">
                <p class="p-bold" style="color:#fff; margin-top: 20px; text-transform:uppercase">Home</p>
            </div>
    ...
    <div class="main-banner2 " id="top-banner">
     <span class="shade-ovarly"></span>
        <div class="main-banner-content">
            <div class="container side-spacing banner-padding txt-align-center">
                <h1 class="anim-bottom-top">THIS IS A TITLE</h1>
                <a href="about.php" class="site-button">ABOUT US</a>
            </div>
        </div>
    </div>
    <div class="main-banner3 " id="top-banner">
     <span class="shade-ovarly"></span>
        <div class="main-banner-content">
            <div class="container side-spacing banner-padding txt-align-center">
                <h1 class="anim-bottom-top">THIS IS A TITLE</h1>
